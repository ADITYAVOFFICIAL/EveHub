  ...
  return (
    <div className="flex-1 bg-white font-poppins select-none">
      <div className="bg-secondary">
        <section className="flex flex-col text-center w-full items-center py-8 lg:py-16 justify-center gap-8 md:gap-0 container min-h-[86vh] relative">
          <div
      ...
      {/* <section className="flex flex-col-reverse lg:flex-row-reverse w-full py-8 md:py-16 justify-between gap-8 md:gap-0 container">
        ...
        >
          ...
          <Link
            to={token ? "/dashboard" : "/auth/signup"}
            className="bg-gradient-to-r from-primary to-primary px-6 p-4 text-white text-center"
            style={{ borderRadius: "12px" }}
          >
            {token ? 'Go to Dashboard' : 'Get Started'}
          </Link>
